...
export default async function AuthPage({ params, searchParams }: AuthPageProps) {
  ...
  return (
    ...
    supportAddressLine1: authString("supportAddressLine1", "Parkhaven 3"),
    supportAddressLine2: authString("supportAddressLine2", "8242 PE Lelystad"),
    supportEmail: authString("supportEmail", "lelystad@schepenkring.nl"),
    supportPhone: authString("supportPhone", "+31 (0)320 711340"),
    resendVerificationLink: authString("resendVerificationLink", "Resend verification email"),
