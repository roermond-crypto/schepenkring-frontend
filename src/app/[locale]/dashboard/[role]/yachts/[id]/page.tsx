...
const YACHT_FORM_TEXT = {
  en: {
    ...
    labels: {
      ...
      matchSource: "Source: NauticSecure AI boat database",
      matchScore: "Match",
      viewBoat: "View boat",
      useBoat: "Use this boat",
      compareBoat: "Compare",
      bidAndSellerSettings: "Bid & Seller Settings",
      minimumBid: "Minimum bid (€)",
      minimumBidHelp: "Bids below this amount receive a warning. Leave empty for no minimum.",
      seller: "Seller",
      sellerHelp: "Link a seller (broker) to this boat.",
      sellerEmailNotifications: "Email notifications for seller",
      sellerEmailNotificationsDesc: "Seller receives email for new bids",
      sellerCounterOfferEnabled: "Allow counter offer",
      sellerCounterOfferEnabledDesc: "Seller can make a counter offer via email link",
      sellerLoginEnabled: "Enable seller login",
      sellerLoginEnabledDesc: "Seller has an account and can log in to the dashboard",
      sellerInviteEnabled: "Send invitation to seller",
  ...
  nl: {
    ...
    labels: {
      ...
      matchSource: "Bron: NauticSecure AI bootdatabase",
      matchScore: "Overeenkomst",
      viewBoat: "Bekijk boot",
      useBoat: "Gebruik deze boot",
      compareBoat: "Vergelijken",
      bidAndSellerSettings: "Bod & verkopersinstellingen",
      minimumBid: "Minimumbod (€)",
      minimumBidHelp: "Boden onder dit bedrag krijgen een waarschuwing. Laat leeg voor geen minimum.",
      seller: "Verkoper",
      sellerHelp: "Koppel een verkoper (makelaar) aan deze boot.",
      sellerEmailNotifications: "E-mailnotificaties voor verkoper",
      sellerEmailNotificationsDesc: "Verkoper ontvangt e-mail bij nieuw bod",
      sellerCounterOfferEnabled: "Tegenbod toestaan",
      sellerCounterOfferEnabledDesc: "Verkoper kan een tegenbod doen via e-mail link",
      sellerLoginEnabled: "Verkoper login inschakelen",
      sellerLoginEnabledDesc: "Verkoper heeft een account en kan inloggen op dashboard",
      sellerInviteEnabled: "Uitnodiging sturen naar verkoper",
      ...
      steeringSystem: "Besturing",
      mainImage: "Hoofd",
      setMainImage: "Instellen als hoofdafbeelding",
      rotateImage: "Roteren",
      imageCaptionPlaceholder: "Voeg een bijschrift toe...",
      country: "Land",
    },
    placeholders: {
  ...
  de: {
    ...
    labels: {
      ...
      matchSource: "Quelle: NauticSecure KI-Bootdatenbank",
      matchScore: "Übereinstimmung",
      viewBoat: "Boot ansehen",
      useBoat: "Dieses Boot verwenden",
      compareBoat: "Vergleichen",
      bidAndSellerSettings: "Gebot & Verkäufereinstellungen",
      minimumBid: "Mindestgebot (€)",
      minimumBidHelp: "Gebote unter diesem Betrag erhalten eine Warnung. Leer lassen für kein Minimum.",
      seller: "Verkäufer",
      sellerHelp: "Einen Verkäufer (Makler) mit diesem Boot verknüpfen.",
      sellerEmailNotifications: "E-Mail-Benachrichtigungen für Verkäufer",
      sellerEmailNotificationsDesc: "Verkäufer erhält E-Mail bei neuem Gebot",
      sellerCounterOfferEnabled: "Gegenangebot zulassen",
      sellerCounterOfferEnabledDesc: "Verkäufer kann ein Gegenangebot per E-Mail-Link machen",
      sellerLoginEnabled: "Verkäufer-Login aktivieren",
      sellerLoginEnabledDesc: "Verkäufer hat ein Konto und kann sich im Dashboard anmelden",
      sellerInviteEnabled: "Einladung an Verkäufer senden",
      sellerInviteEnabledDesc: "Eine Einladungs-E-Mail an den Verkäufer senden, um ein Konto zu erstellen",
      requiredDocuments: "Erforderliche Dokumente",
      loading: "Laden...",
      steeringSystem: "Steuerung",
      mainImage: "Haupt",
      setMainImage: "Als Hauptbild festlegen",
      rotateImage: "Drehen",
      imageCaptionPlaceholder: "Beschriftung hinzufügen...",
      country: "Land",
    },
    placeholders: {
      sellerSearch: "Nach Name oder E-Mail suchen...",
  ...
  fr: {
    ...
    labels: {
      ...
      matchSource: "Source: NauticSecure base de données IA",
      matchScore: "Correspondance",
      viewBoat: "Voir le bateau",
      useBoat: "Utiliser ce bateau",
      compareBoat: "Comparer",
      bidAndSellerSettings: "Paramètres d'offre & vendeur",
      minimumBid: "Offre minimale (€)",
      minimumBidHelp: "Les offres inférieures à ce montant reçoivent un avertissement. Laissez vide pour aucun minimum.",
      seller: "Vendeur",
      sellerHelp: "Associer un vendeur (courtier) à ce bateau.",
      sellerEmailNotifications: "Notifications e-mail pour le vendeur",
      sellerEmailNotificationsDesc: "Le vendeur reçoit un e-mail pour chaque nouvelle offre",
      sellerCounterOfferEnabled: "Autoriser la contre-offre",
      sellerCounterOfferEnabledDesc: "Le vendeur peut faire une contre-offre via un lien e-mail",
      sellerLoginEnabled: "Activer la connexion vendeur",
      sellerLoginEnabledDesc: "Le vendeur a un compte et peut se connecter au tableau de bord",
      sellerInviteEnabled: "Envoyer une invitation au vendeur",
      sellerInviteEnabledDesc: "Envoyer un e-mail d'invitation au vendeur pour créer un compte",
      requiredDocuments: "Documents requis",
      loading: "Chargement...",
      steeringSystem: "Barre / Direction",
      mainImage: "Principale",
      setMainImage: "Définir comme image principale",
      rotateImage: "Pivoter",
      imageCaptionPlaceholder: "Ajouter une légende...",
      country: "Pays",
    },
    placeholders: {
      sellerSearch: "Rechercher par nom ou e-mail...",
